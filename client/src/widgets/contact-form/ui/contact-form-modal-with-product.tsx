...
import { sendContactFormWithProduct } from "@/widgets/contact-form/services"
...
interface ContactFormModalWithProductProps {
  dialogButtonText?: string
  dialogButtonIcon?: ComponentType<LucideProps>
  product: ProductBase
}

const ContactFormModalWithProduct = ({
  ...
  ContactFormModalWithProductProps) => {
  const handleSubmit = async (data: ContactFormSchema) => {
    return sendContactFormWithProduct({ ...data, product })
  }
  return (
    <Dialog>
...
export { ContactFormModalWithProduct }
